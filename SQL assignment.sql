...
(
  ...
  insert into Customers values(1,'isha','inuganti','tuni','India',1233455667)
  insert into Customers values(2,'alex','sunil','xyakil','Germany',1233445566)
  insert into Customers values(3,'nani','kammal','vijaynagar','Goa',122343455)
